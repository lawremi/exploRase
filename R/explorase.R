  ...
  network = NULL, entity_lists = NULL, gobi = ggobi_get(), quit_on_exit = F) 
{
    ...
    actionEntries <- list(
      ...
      list("InterestingEntsMenu", NULL, "Find _Interesting Entities"), 
      list("SimilarEntsMenu", NULL, "Find _Similar Entities"), 
      list("ClusterMenu", NULL, "Find _Clusters"), 
      list("Patterns", NULL, "Find _Patterns...", NULL, 
           "Open the pattern finding tool", MnuFindPattern_cb), 
      list("Correlation", NULL, "Co_rrelation", NULL, 
            "Find correlation between genotypes", MnuCompareCorr_cb), 
      list("Covariance", NULL, "Co_variance", NULL, 
            "Find covariance between genotypes", MnuCompareCov_cb), 
      list("Difference", NULL, "_Difference", NULL, 
            "Find interesting genes by difference", MnuDiff_cb), 
      list("Regression", NULL, "_Regression", NULL, 
            "Find interesting genes by regression", MnuRegression_cb), 
      list("Angle", NULL, "_Angle", NULL, "Find interesting genes by angle", 
            MnuAngle_cb), 
      list("Mahalanobis", NULL, "_Mahalanobis", NULL, 
            "Find interesting genes by the Mahalanobis Method", 
            MnuMahalanobis_cb), 
      list("Euclidean", NULL, "_Euclidean", NULL, 
            "Use Euclidean distance measure", MnuEuclidean_cb), 
      list("CorrelationDistance", NULL, "_Correlation", NULL, 
            "Use Correlation distance measure", MnuCorr_cb), 
      list("ZeroCorr", NULL, "_Zero Corr", NULL, 
            "Use Zero Correlation distance measure", MnuZerocorr_cb), 
      list("HClust", NULL, "_Hierarchical", NULL, 
            "Cluster genes hierarchically", Mnuhclust_cb),
